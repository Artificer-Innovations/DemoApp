    ...
    <View style={[styles.header, { paddingTop: statusBarHeight }]}>
      <View style={styles.headerContent}>
        ...
        >
          <View style={styles.iconContainer}>
            <Svg width={32} height={32} viewBox="0 0 200 200">
              ...
              <Line x1="60" y1="120" x2="70" y2="120" stroke="#8B5CF6" strokeWidth="1.5" opacity="0.6" />
              <Line x1="60" y1="140" x2="70" y2="140" stroke="#8B5CF6" strokeWidth="1.5" opacity="0.6" />
              <Line x1="130" y1="120" x2="140" y2="120" stroke="#8B5CF6" strokeWidth="1.5" opacity="0.6" />
              <Line x1="130" y1="140" x2="140" y2="140" stroke="#8B5CF6" strokeWidth="1.5" opacity="0.6" />
            </Svg>
          </View>
        ...
        <View style={styles.rightSection}>
          {auth.user ? (
            <UserMenu user={auth.user} profile={profile.profile} navigation={navigation} />
          ) : (
            <>
              <TouchableOpacity
